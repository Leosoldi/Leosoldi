...
//$result_nome_arquivo = "SELECT * FROM arquivos ORDER BY id DESC"; 
//$resultado_nome = mysqli_query($conn, $result_nome_arquivo);
//SELECIONA BANCO
...
$res = mysqli_query($conn, $sql);
          ...
          $i     = 0;
           ...
           while ($f = mysqli_fetch_array($res)) {
                 ...
                 $obj['id'] = $f['id']; 
                 $obj['nome'] = $f['nome']; 
                 $obj['proprietario'] = $f['proprietario']; 
                 $obj['nome_arquivo'] = $f['nome_arquivo']; 
                 $obj['data'] = $f['data']; 
                 $objs[$i] = $obj; 
                 $i++;
               }
...
?>
  ...
  <head>
    ...
    <title>Sistema Transvirtus | Listar</title>
    <!-- Favicon icon -->
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Listar Arquivos</h4>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">listar Arquivos
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                      <a type="button" class="btn btn-success text-white" href="cadastrar.php">Novo Arquivo</a>
                      <thead>
                        <tr>
                          <th>ID:</th>
                          ...
                          <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="<?=$dir.$obj['nome_arquivo']?>"><?=$obj['nome_arquivo']?></a></td>
                                    <td><?php echo $obj['nome'];?></td>
                                    <td><?php echo $obj['proprietario'];?></td>
                                    <td><?php echo $obj['data'];?></td>
                                    <td><?php echo "<a type='button' class='btn btn-danger btn-sm text-white' href='apaga_arquivo.php?id=$obj[id]&nome_arquivo=$obj[nome_arquivo]'".">Apagar</a>";?></td>
                                  </tr>
                                  <?php closedir(); } ?> 
                              </tbody>
                      <tfoot>
